...
log_measures = ['density_dfg', 'structure_dfg', 'cyclomatic_number_dfg', 'separability_ratio_dfg', 'sequentiality_ratio_dfg', 'cyclicity_dfg']
...
if __name__ == "__main__":
    ...
    distinct_activities = ['distinct_activities_min', 'distinct_activities_max', 'distinct_activities_mean',
                           'distinct_activities_std', 'event_density', 'distinct_activities_non_overlap', 'complexity_factor']
    #####
    ...
    #####
    dfg_based = ['n_nodes_dfg', 'n_edges_dfg', 'coeff_of_connectivity_dfg', 'avg_node_degree_dfg', 'max_node_degree_dfg',
    ...
    log_measures = ['eventropy_global_block', 'eventropy_global_block_flattened']
